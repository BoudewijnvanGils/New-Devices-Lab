...
void setup(){
    ...
    gdo0 = 9;  // for Arduino! GDO0 on pin 6.
    ...
    ELECHOUSE_cc1101.setMHZ(433.90);   // Here you can set your basic frequency. The lib calculates the frequency automatically (default = 433.92).The cc1101 can: 300-348 MHZ, 387-464MHZ and 779-928MHZ. Read More info from datasheet.
...
void loop(){
    ...
    if (ELECHOUSE_cc1101.SpiReadStatus(CC1101_RXBYTES)) {
      Serial.println ("Data is being recieved");
    }
