...
char *transmitt_char = "Open Sesame";
...
gdo0 = 9;  // mega adk pin 9
    ...
    ELECHOUSE_cc1101.SetTx(433.90);   // Here you can set your basic frequency. The lib calculates the frequency automatically (default = 433.92).The cc1101 can: 300-348 MHZ, 387-464MHZ and 779-928MHZ. Read More info from datasheet.
