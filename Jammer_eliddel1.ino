...
#define cc1101_Select()  digitalWrite(cs_jam, LOW)
// Deselect (SPI) CC1101
#define cc1101_Deselect()  digitalWrite(cs_jam, HIGH)
...
#define BIT_GDO0_RX  9

//Defince gdo0_jam port/bit
#define PORT_GDO0_JAM  PIND
#define BIT_GDO0_JAM  3   //we are only receiving, port doesn't work

//Define MISO port/bit
#define PORT_SPI_MISO  PINB
#define BIT_SPI_MISO  12
...
boolean get_GDO0_state()
  {
    return bitRead(PORT_GDO0_JAM, BIT_GDO0_JAM);
  }
...
CCPACKET getJamPacket(){
   CCPACKET jamData;
   byte thing[10] = {0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA};
...
void set_patable_jam() {
  byte PA_TABLE[] = {0xC8, 0x34, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
  writeBurstReg(CC1101_PATABLE, PA_TABLE, 8);
}
